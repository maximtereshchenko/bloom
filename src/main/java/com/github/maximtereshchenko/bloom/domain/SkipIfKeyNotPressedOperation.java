...
/**
 * ExA1 - SKNP Vx. Skip next instruction if key with the value of Vx is not pressed. Checks the keyboard, and if the key
...
class SkipIfKeyNotPressedOperation extends SkipIfKeyOperation {
    ...
    SkipIfKeyNotPressedOperation(Registers registers, Keypad keypad, HexadecimalSymbol registerName) {
