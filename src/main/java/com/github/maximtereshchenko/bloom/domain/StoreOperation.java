 ...
 * of registers V0 through Vx into memory, starting at the address in I. Index is incremented along the way.
 */
final class StoreOperation extends RegisterMemoryTransferOperation {
    ...
    @Override
    void transfer(RandomAccessMemory randomAccessMemory, MemoryAddress memoryAddress, Register<UnsignedByte> register) {
